<?php
	...
	define("PASSWORD", "password"); // Пароль доступа в админ панель
	...
	define("CSS_PATH", "/templates/assets/css"); // путь к css файлам
	define("JS_PATH", "/templates/assets/js"); // путь к js файлам
